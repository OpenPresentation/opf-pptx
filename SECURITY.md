...
`@openpresentation/opf-pptx` is a local library. It must not require hosted services, telemetry, commercial SDKs, AI services, or LibreOffice in the runtime critical path.

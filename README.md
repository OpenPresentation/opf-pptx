...
- `var:<id>` variables;
- translucent colors;
- other engine-derived chrome: card and chart panels, chart series and labels, table cell text, the default table header fill, and default text on a literal background. These colors are contrast-selected, not named by the document.
